...
-- disebut sheet Kumpulan Data — kolom LBS di situ semuanya 0/kosong).
...
--
-- lahan_baku_sawah_ha (kolom "Lahan Baku Sawah (2024)", indeks 21) DISIMPAN
-- utk referensi tapi SENGAJA TIDAK dipakai skoring C.A2 "Luas Lahan (12%)":
-- nilainya level KABUPATEN (ratusan-ribuan ha), sementara ambang resmi
-- Tabel 4 (>500ha=100 ... <=25ha=20) jelas dirancang utk skala jauh lebih
-- kecil (per-usulan/kecamatan) — kalau dipaksa pakai skala kabupaten,
-- hampir semua kabupaten otomatis kena >500ha=100, tidak diskriminatif.
